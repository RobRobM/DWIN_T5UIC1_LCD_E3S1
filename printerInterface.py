...
class PrinterData:
	...
	def __init__(self, API_Key, URL='127.0.0.1'):
		...
		# ------------- TODO: change Socket to klippy socket (-a Argument in Klipper Args) ----------
	
		self.ks = KlippySocket('/home/USER/printer_data/comms/klippy.sock', callback=self.klippy_callback)
		subscribe = {
			"id": 4001,
